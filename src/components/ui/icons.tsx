...
// Coin icon for token counts
export function CoinIcon({ className }: IconProps) {
  return (
    <svg className={cn('w-4 h-4', className)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <circle cx="12" cy="12" r="9" />
      <text x="12" y="16" textAnchor="middle" fontSize="10" fill="currentColor" fontWeight="bold" stroke="none">T</text>
    </svg>
  );
}
...
// Thumbs down icon
export function ThumbsDownIcon({ className, filled }: IconProps & { filled?: boolean }) {
  return (
    <svg className={cn('w-4 h-4', className)} fill={filled ? 'currentColor' : 'none'} stroke="currentColor" viewBox="0 0 24 24">
