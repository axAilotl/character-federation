...
import { type BinaryData, fromString } from '..';
import type { CCv3Data } from '../schemas';
import type {
  VoxtaWriteAsset,
  VoxtaWriteOptions,
  VoxtaBuildResult,
...
import { standardToVoxta } from './macros';
import { ccv3LorebookToVoxtaBook } from './mapper';
...
export function writeVoxta(
  ...
  let { includePackageJson = false } = options;
